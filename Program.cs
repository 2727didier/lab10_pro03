...
namespace lab10_pro03
{
    internal class Program
    {
                    ...
                    if (int.TryParse(Console.ReadLine(), out opcion))
                    {
                        switch (opcion)
                        {
                            case 1:
                                ...
                                break;
                            case 2:
                                int devoluciones = SubmenuDevoluciones(producto, ventas);
            ...
            static int SubmenuDevoluciones(string producto, Dictionary<string, int> ventas)
            {
                int opcion;
                    ...
                    if (int.TryParse(Console.ReadLine(), out opcion))
                    {
                        switch (opcion)
                        {
                            case 1:
                                ...
                                {
                                    cantidadDevoluciones = devoluciones;
                                ...
                                break;
                            case 2:
                                Console.WriteLine("Cancelando la devolución.");
                                break;
                            default:
                                Console.WriteLine("Opción no válida. Intente de nuevo.");
                                break;
